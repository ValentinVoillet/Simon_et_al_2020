...
TCR.pData <- TCR.pData[c(1:39, 41:43, 45:120, 123:125, 127, 130, 132, 135:146, 148:154, 157:158), ] 
TCR.pData %>%
  arrange(patient.id) %>%
...
bind_rows(dt.P5) %>%
  ...
  filter(variable != "M2" & variable != "M6") %>%
...
bind_rows(dt) %>%
  ...
  ggplot(aes(x = cluster, y = freq)) +
    ...
    scale_fill_manual(values = c("#4FFFFF", "#ADB2BD", "#F28500", "#3EA055")) +
    labs(y = "TRAC - freq clonotypes", fill = "Fraction") +
    ylim(c(0, 1)) +
    theme_bw() +
    theme(legend.position = "bottom",
          axis.title.x = element_blank(),
...
bind_rows(dt) %>%
  ...
  labs(y = "freq clonotypes", fill = "Fraction", alpha = "Outcome") +
  guides(alpha = guide_legend(override.aes = list(alpha = c(1, .3), fill = "grey"))) +
  theme_bw() +
  theme(legend.position = "bottom",
        axis.title.x = element_blank(),
...
bind_rows(dt) %>%
  ...
  ggplot(aes(x = cluster, y = freq)) +
    geom_boxplot(aes(fill = fraction)) +
    scale_fill_manual(values = c("#4FFFFF", "#ADB2BD", "#F28500", "#3EA055")) +
    labs(y = "TRBC - freq clonotypes", fill = "Fraction") +
    ylim(c(0, 1)) +
    theme_bw() +
    theme(legend.position = "bottom",
          axis.title.x = element_blank(),
